...
public class FirstDmn {
	...
	public static void main(String[] args) {
		...
		//根据默认配置创建引擎的配置实例 activiti.dmn.cfg.xml 默认使用这个文件
		...
		//进行规则 部署
		DmnDeployment dep = rService.createDeployment().addClasspathResource("dmn/first.dmn").deploy();
		//进行数据查询
