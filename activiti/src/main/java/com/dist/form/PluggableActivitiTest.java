...
public class PluggableActivitiTest extends PluggableActivitiTestCase {

	@Deployment(resources = { "FormKey.bpmn20.xml", "diagrams/form/start.form", "diagrams/form/first-step.form", "diagrams/form/second-step.form" })
	public void testTaskFormsWithVacationRequestProcess() {
		...
		assertEquals("<input id=\"first-name\" value=\"kafeitu\" />", renderedTaskForm); // 可以直接把数据直接输出 
	}
}