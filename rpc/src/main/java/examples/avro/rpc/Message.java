...
public class Message extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2078086583540721421L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Message\",\"namespace\":\"examples.avro.rpc\",\"fields\":[{\"name\":\"to\",\"type\":\"string\"},{\"name\":\"from\",\"type\":\"string\"},{\"name\":\"body\",\"type\":\"string\"}]}");
   ...
   */
  public static examples.avro.rpc.Message.Builder newBuilder() {
    return new examples.avro.rpc.Message.Builder();
  }
   ...
   * @return A new Message RecordBuilder
   */
  public static examples.avro.rpc.Message.Builder newBuilder(examples.avro.rpc.Message.Builder other) {
    if (other == null) {
      return new examples.avro.rpc.Message.Builder();
    } else {
      return new examples.avro.rpc.Message.Builder(other);
    }
  }
   ...
   * @return A new Message RecordBuilder
   */
  public static examples.avro.rpc.Message.Builder newBuilder(examples.avro.rpc.Message other) {
    if (other == null) {
      return new examples.avro.rpc.Message.Builder();
    } else {
      return new examples.avro.rpc.Message.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Message>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(examples.avro.rpc.Message.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(examples.avro.rpc.Message other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.to)) {
        this.to = data().deepCopy(fields()[0].schema(), other.to);
    ...
    /**
      ...
      * @return This builder.
      */
    public examples.avro.rpc.Message.Builder setTo(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public examples.avro.rpc.Message.Builder clearTo() {
      to = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public examples.avro.rpc.Message.Builder setFrom(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public examples.avro.rpc.Message.Builder clearFrom() {
      from = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public examples.avro.rpc.Message.Builder setBody(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public examples.avro.rpc.Message.Builder clearBody() {
      body = null;
